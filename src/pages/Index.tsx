...
const pillarServices = [
  ...
  },
  {
    ...
    image: nr12RealImg,
    href: "/servicos/nr12",
    tags: ["APR", "Projeto", "Adequação"],
  },
  {
    title: "NR11 · Inspeções e Plano de Rigging",
...
const processSteps = [
  ...
  { num: "04", title: "Entrega da Documentação", desc: "Laudo técnico completo com ART e memorial de cálculo detalhado." },
];
...
const testimonials = [
  {
    quote: "Profissionais sérios, dedicados, empáticos, pontuais, precisos e extremamente atenciosos. Precisei vistoriar o meu veículo e o engenheiro Vinícius me atendeu super bem, me embasando do início ao fim do processo em todos os pontos os quais precisei tratar. Total credibilidade apresentada! Recomendo a todos!",
    name: "Luciana C.",
    role: "Cliente",
    company: "Google Reviews",
  },
  {
    quote: "Primeiramente, gostaria de deixar claro que é a primeira vez que passamos pela situação e para encontrar uma empresa de credibilidade e na situação de vulnerabilidade é bem complicado. Gostaria de deixar o meu muito obrigada à VSM Engenharia pela seriedade e excelente trabalho e especialmente ao Vinicius que conseguiu nos passar confiança e credibilidade no seu profissionalismo. Super indico esta empresa.",
    name: "APR Transportes",
    role: "Cliente",
    company: "Google Reviews",
  },
  {
    quote: "Muito atencioso, serviço de excelência e profissionalismo profissional ao profissional Vinicius que foi o que me ajudou a todo momento sempre que eu precisasse. Recomendo de olhos fechados!",
    name: "Luan Magnata",
    role: "Cliente",
    company: "Google Reviews",
  },
  {
    quote: "A VSM Engenharia provou suporte e serviço prestado com excelência e rapidez. Visita técnica para coleta de dados + elaboração de relatório técnico + elaboração PMOC + Certificado PMOC + Cálculo Carga Térmica + ART. O Vinícius é um excelente profissional, educado e atencioso!",
    name: "Ronaldo Novaes",
    role: "Cliente",
    company: "Google Reviews",
  },
  {
    quote: "A VS Engenharia é uma empresa totalmente competente para os serviços prestados. Na empresa em que trabalho, elaboraram um PMOC, bem estruturado e material de alta qualidade. O Vinícius é um excelente profissional, muito educado e atencioso. Recomendo DEMAIS!!!",
    name: "Pedro Frade",
    role: "Local Guide",
    company: "Google Reviews",
  },
  {
    quote: "Indico a empresa, super profissionais e atenciosos.",
    name: "Rodrigo Tafner",
    role: "Cliente",
    company: "Google Reviews",
  },
  {
    quote: "Empresa bem profissional e equipada, passou todas as adequações que precisava ser feito para a emissão do laudo de NR13 esclarecendo todas as dúvidas, são pontuais e seguem à risca os prazos que promete desde a visita até a entrega final. Voltarei a fazer negócio com a VSM.",
    name: "Leandro Rodrigues",
    role: "Cliente",
    company: "Google Reviews",
  },
  {
    quote: "Empresa extremamente confiável, serviço de qualidade. Profissional demonstrou atenção em cada detalhe e esclareceu todas as dúvidas.",
    name: "Qualidade",
    role: "Cliente",
    company: "Google Reviews",
  },
...
function useCarousel(count: number, autoplayMs = 5000) {
  const [emblaRef, emblaApi] = useEmblaCarousel({ loop: true, align: "start", containScroll: false, slidesToScroll: 1 });
  const [selected, setSelected] = useState(0);
  const [snapCount, setSnapCount] = useState(count);
  ...
  return { emblaRef, selected, scrollPrev, scrollNext, scrollTo, snapCount };
}
...
function CarouselNav({ onPrev, onNext }: { onPrev: () => void; onNext: () => void }) {
  return (
    <div className="flex gap-2">
      <button type="button" onClick={onPrev} aria-label="Slide anterior" className="h-9 w-9 rounded-lg border border-white/15 flex items-center justify-center text-primary-foreground/60 hover:bg-white/10 hover:text-primary-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cta">
        <ChevronRight className="h-4 w-4 rotate-180" aria-hidden="true" />
      </button>
      <button type="button" onClick={onNext} aria-label="Próximo slide" className="h-9 w-9 rounded-lg border border-white/15 flex items-center justify-center text-primary-foreground/60 hover:bg-white/10 hover:text-primary-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cta">
      ...
      <section className="relative min-h-[100vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full lg:w-[55%] xl:w-[50%] flex items-center min-h-[100vh]">
          <div className="relative z-10 px-6 sm:px-10 lg:px-16 xl:px-20 py-24 lg:py-0 w-full max-w-2xl mx-auto lg:mx-0 lg:ml-auto">
            ...
            <div className="animate-fade-in mb-8" style={{ animationDelay: "0ms" }}>
              <div className="flex items-center gap-2 text-sm text-primary-foreground/80">
                <div className="flex gap-0.5" role="img" aria-label="Avaliação 5 de 5 estrelas">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} aria-hidden="true" className="w-3.5 h-3.5 text-cta fill-cta" viewBox="0 0 20 20">
                      <path d="M10 1l2.39 4.84 5.34.78-3.87 3.77.92 5.32L10 13.28l-4.78 2.43.92-5.32L2.27 6.62l5.34-.78z" />
                    </svg>
                  ))}
                </div>
                <span className="text-primary-foreground/70">5.0 — Avaliações Google</span>
              </div>
            </div>
            ...
            {/* Subtext */}
            <p className="text-base sm:text-lg text-primary-foreground/85 max-w-lg leading-relaxed animate-fade-in" style={{ animationDelay: "300ms" }}>
              Inspeções <strong className="text-primary-foreground">NR13, NR12 e NR11</strong> com laudos robustos, memoriais de cálculo e ART. Reclassificação de Monta com laudo técnico completo. Referência no Sudeste.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3 mt-12 pt-8 border-t border-primary-foreground/10 animate-fade-in" style={{ animationDelay: "460ms" }}>
              {[
                ...
                <div key={item.text} className="flex items-center gap-2 text-sm text-primary-foreground/75">
                  <item.icon className="h-4 w-4 text-cta" aria-hidden="true" />
                  <span>{item.text}</span>
                </div>
              ))}
            </div>
        ...
        {/* Floating credential cards — hidden on mobile, visible on lg+ */}
        <div className="absolute bottom-16 right-12 z-10 hidden lg:flex flex-col gap-3 max-w-xs animate-fade-in" style={{ animationDelay: "550ms" }}>
        ...
        {/* Scroll indicator */}
        <div aria-hidden="true" className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 hidden lg:flex flex-col items-center gap-2 animate-fade-in" style={{ animationDelay: "700ms" }}>
          ...
          <RevealSection className="mb-16">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
              ...
              <p className="text-muted-foreground max-w-md text-lg leading-relaxed">
                Inspeções normativas e diagnóstico industrial com o mesmo rigor técnico e documentação robusta.
              </p>
            </div>
          </RevealSection>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <RevealSection variant="right" className="lg:col-span-7 lg:pl-4">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4 text-base">
                Somos uma empresa de engenharia com atuação no <strong className="text-foreground">Sudeste do Brasil</strong>, 
              ...
              <div className="relative mb-8">
                ...
                <div className="space-y-5">
                  {[
                    { icon: Shield, num: "01", title: "Laudos e Diagnóstico Robustos", desc: "Memoriais de cálculo detalhados e documentação com ART registrada." },
                ...
                {risks.map((r) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="text-sm text-cta font-semibold">{r.detail}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex gap-3 w-full md:w-auto">
                ...
                <input
                  ...
                  className="flex-1 md:w-72 h-12 px-4 rounded-xl border border-white/15 bg-white/[0.08] text-primary-foreground placeholder:text-primary-foreground/50 text-sm focus:outline-none focus:ring-2 focus:ring-cta/50"
                />
                <Button type="submit" className="bg-cta text-cta-foreground hover:bg-cta-hover font-bold rounded-xl h-12 px-6 shrink-0">
                  Inscrever
                </Button>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <RevealSection variant="left">
              ...
              <div className="space-y-4 mb-8">
                {[
                  { icon: Phone, title: "(11) 95453-4057", sub: "Seg a Sex, 8h às 18h", href: "tel:+5511954534057" },
                  { icon: Mail, title: "contato@vsmengenharia.com", sub: "Resposta em até 24h", href: "mailto:contato@vsmengenharia.com" },
                  ...
                  return item.href ? (
                    <a key={item.title} href={item.href} className="flex items-center gap-4 bg-card rounded-xl border border-border/60 p-4 hover:border-primary/40 hover:shadow-soft transition-all">
                      {content}
                    </a>
                  ) : (
              ...
              <div className="flex gap-3">
                <a href="https://wa.me/5511954534057" target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp" className="h-11 w-11 rounded-xl bg-success flex items-center justify-center text-success-foreground hover:opacity-90 transition-opacity">
                  <Phone className="h-5 w-5" aria-hidden="true" />
                </a>
                <a href="https://www.instagram.com/vsm_engenharia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram VSM Engenharia" className="h-11 w-11 rounded-xl bg-card border border-border/60 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/30 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/engenheiro-mec%C3%A2nico-vinicius-souza-692603203/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn VSM Engenharia" className="h-11 w-11 rounded-xl bg-card border border-border/60 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/30 transition-colors">
                ...
                <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); }}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="relative">
                      ...
                      <input id="contact-company" name="company" type="text" placeholder="Empresa" aria-label="Empresa" autoComplete="organization" className="w-full h-11 pl-10 pr-4 rounded-xl border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-cta/50 focus:border-cta/50" />
                    </div>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="relative">
                      ...
                      <input id="contact-phone" name="phone" type="tel" placeholder="Telefone" aria-label="Telefone" autoComplete="tel" className="w-full h-11 pl-10 pr-4 rounded-xl border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-cta/50 focus:border-cta/50" />
                    </div>
                    <div className="relative">
