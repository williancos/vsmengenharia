...
import heroHvac from "@/assets/projetos-climatizacao/hero-hvac.jpg?w=480;768;1024;1440;1920&format=webp&as=img";
...
export default function ProjetosClimatizacao() {
  const jsonLd = useMemo(() => ({
    ...
    "@type": "Service",
    name: "Projetos de Climatização HVAC",
    ...
    description: "Projetos HVAC completos com cálculo de carga térmica, projeto executivo e ART. Eficiência energética conforme ABNT e ASHRAE.",
    url: "https://www.vsmengenharia.com/servicos/projetos-climatizacao",
  }), []);
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[85vh] flex items-center"><div className="absolute inset-0">
          <img
            {...imgProps(heroHvac)}
            alt=""
            aria-hidden="true"
